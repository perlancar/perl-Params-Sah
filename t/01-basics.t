...
subtest "opt:on_invalid=bool opt:optional_params" => sub {
    my $v = gen_validator({named=>1, on_invalid=>"bool", optional_params=>["age"]}, name=>"str*", age=>"int");
    is($v->({}), 0);
    is($v->({name=>"name"}), 1);
...
subtest "opt:on_invalid=str opt:optional_params" => sub {
    my $v = gen_validator({named=>1, on_invalid=>"str", optional_params=>["age"]}, name=>"str*", age=>"int");
    isnt($v->({}), '');
    is($v->({name=>"name"}), '');
